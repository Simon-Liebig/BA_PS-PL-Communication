...
set origin_dir "/home/simon/FPGADEVELOPER/aus_tcl"
...
# Create block design
source $origin_dir/create-design.tcl

# Generate the wrapper
make_wrapper -files [get_files *${design_name}.bd] -top
add_files -norecurse ${origin_dir}/${design_name}/${design_name}.srcs/sources_1/bd/${design_name}/hdl/${design_name}_wrapper.vhd
