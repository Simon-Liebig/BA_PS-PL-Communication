...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set JA4_5_N [ create_bd_port -dir O JA4_5_N ]
  set JA4_5_P [ create_bd_port -dir O JA4_5_P ]
  set JA6_7_N [ create_bd_port -dir O JA6_7_N ]
  set JA6_7_P [ create_bd_port -dir O JA6_7_P ]
  ...
  # Create instance: fir_memo_top_0, and set properties
  set fir_memo_top_0 [ create_bd_cell -type ip -vlnv user.org:user:fir_memo_top:1.0 fir_memo_top_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M01_AXI] [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]

  # Create port connections
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins axi_bram_ctrl_0/bram_clk_a] [get_bd_pins fir_memo_top_0/clk_in]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a [get_bd_pins axi_bram_ctrl_0/bram_en_a] [get_bd_pins fir_memo_top_0/ena]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_pins axi_bram_ctrl_0/bram_we_a] [get_bd_pins fir_memo_top_0/wea]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a] [get_bd_pins fir_memo_top_0/dina]
  connect_bd_net -net axi_cdma_0_cdma_introut [get_bd_pins axi_cdma_0/cdma_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net fir_memo_top_0_JA4_5_N [get_bd_ports JA4_5_N] [get_bd_pins fir_memo_top_0/JA4_5_N]
  connect_bd_net -net fir_memo_top_0_JA4_5_P [get_bd_ports JA4_5_P] [get_bd_pins fir_memo_top_0/JA4_5_P]
  connect_bd_net -net fir_memo_top_0_JA6_7_N [get_bd_ports JA6_7_N] [get_bd_pins fir_memo_top_0/JA6_7_N]
  connect_bd_net -net fir_memo_top_0_JA6_7_P [get_bd_ports JA6_7_P] [get_bd_pins fir_memo_top_0/JA6_7_P]
  connect_bd_net -net fir_memo_top_0_douta [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins fir_memo_top_0/douta]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_102M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_102M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_102M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_102M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_102M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins fir_memo_top_0/addra] [get_bd_pins xlslice_0/Dout]

  # Create address segments
  create_bd_addr_seg -range 0x00002000 -offset 0x42000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
