...
HD_PWD='/home/simon/FPGADEVELOPER/HWD-CDMA-BRAM/HWD-CDMA-BRAM.runs/design_1_fir_memo_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fir_memo_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fir_memo_top_0_0.tcl
