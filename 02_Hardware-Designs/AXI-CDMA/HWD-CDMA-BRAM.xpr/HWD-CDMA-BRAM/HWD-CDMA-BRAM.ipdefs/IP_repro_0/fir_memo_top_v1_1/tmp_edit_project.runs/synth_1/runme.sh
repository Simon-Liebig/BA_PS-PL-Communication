...
HD_PWD='/home/simon/IP_repro/fir_memo_top_v1_1/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_memo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_memo_top.tcl
