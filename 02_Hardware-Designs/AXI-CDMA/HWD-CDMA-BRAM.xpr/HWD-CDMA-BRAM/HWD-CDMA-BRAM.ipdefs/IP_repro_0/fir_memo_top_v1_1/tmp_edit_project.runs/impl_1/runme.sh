...
HD_PWD='/home/simon/IP_repro/fir_memo_top_v1_1/tmp_edit_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_memo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_memo_top.tcl -notrace
