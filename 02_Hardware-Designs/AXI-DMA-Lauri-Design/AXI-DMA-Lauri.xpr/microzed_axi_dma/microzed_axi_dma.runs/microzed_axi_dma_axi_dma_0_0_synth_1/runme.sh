...
HD_PWD='/home/simon/FPGADEVELOPER/ALT/AXI-DMA-Lauri-Design/microzed_axi_dma/microzed_axi_dma.runs/microzed_axi_dma_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microzed_axi_dma_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microzed_axi_dma_axi_dma_0_0.tcl
